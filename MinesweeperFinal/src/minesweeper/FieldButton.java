...
*
*   FieldButton instances incorporate an FSM, using the enumerated type BtnState. BtnStates represent af combination of
...
public class FieldButton extends Button {
    ...
    public static final String LOSE =       "-fx-background-color: brown; -fx-border-color: black";
    public static final String WIN =        "-fx-background-color: chartreuse; -fx-border-color: black";
